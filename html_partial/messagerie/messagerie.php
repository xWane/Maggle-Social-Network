...
<main class="container-center dis">
    ...
    foreach($datas as $datas) {
        ...
        echo    "<div class='favoris mess'>
                <a href='messagerie.php?reg_err=$userId'_'$user_ids class=' align'> <img src='../../public/img/$user_pics' alt='Profile' class='icon profile-picture img-vide'>$user_names $user_surnames<span class='text-fovoris'></span> </a>
                </div>";
        }
    }
    ?>
