...
<div class="sticky">
    ...
    <div class="nav-bar">
        <div class="item">
            <a href="index.php" class="color1 align"> <img src="../../public/icon/home.svg" alt="Accueil" class="icon"> <span class="text-nav-bar">Accueil</span> </a>
        </div>
        <div class="item">
        ...
        <div class="item">
            <a href="groupe.php" class="color3 align"> <img src="../../public/icon/groupes.svg" alt="Groupes" class="icon"> <span class="text-nav-bar">Groupes</span> </a>
        </div>
        <div class="item">
