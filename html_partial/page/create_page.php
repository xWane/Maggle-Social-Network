...
<div class="bg">
    <img src="../../public/img/img-random.jpg" alt="Banière de profil" class="bg-img img-vide">
</div>

<div class="info">
    <img src="../../public/img/pp-g.jpg" alt="Image de profil" class="pp img-vide">
    <div></div>
    <h2 class="profil">Nom de la Page</h2>
...
<p class="text-bio">Ajouter bio de la page</p>
